curl -H "Content-Type: application/json" \
     ...
     -d '{"interests":["hello"],"fcm":{"notification":{"title":"[Alert] Update on Your Attic Fan", "body":"Your attic fan appears no longer be working. Please check it as soon as you can."}}}'
